...
public class SettingsMenuStudentInformation extends Fragment implements View.OnClickListener{
    ...
    TextView tv_col0;
    RadioButton _col5a, _col5b, _col6a, _col6b, _col6c,  _col8a, _col8b, _col10a, _col10b, _col12a, _col12b;
...
//    private SimpleDateFormat dateFormatter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        _col18 = (CheckBox) mLinearLayout.findViewById(R.id._col18);
        _col19 = (CheckBox) mLinearLayout.findViewById(R.id._col19);
...
//                if (!cur_data.getString(21).isEmpty()) {
//                    _col21.updateDate(Integer.parseInt(cur_data.getString(21).substring(0, 4)), Integer.parseInt(cur_data.getString(21).substring(5, 7)) - 1, Integer.parseInt(cur_data.getString(21).substring(8, 10)));}
