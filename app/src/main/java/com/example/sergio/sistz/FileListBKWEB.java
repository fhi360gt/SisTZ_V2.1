...
public class FileListBKWEB extends Activity {
    ...
    //    ArrayList<HashMap<String>> jsonlist = new ArrayList<HashMap<String>>();
...
//                    startActivity(intent);
    ...
    void json(String emis){
        url = "http://fhi360bi.org/user/Sis_tz_bk/get_list.php?emis="+emis;
    ...
    public void dialogAlert1(final String database){
        ...
        dialogo1.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo1, int id) {
                ...
                startIntent.putExtra("url", "http://www.fhi360bi.org/user/Sis_tz_Bk/uploads/" + bundle.getString("emis") + "/" + database);
