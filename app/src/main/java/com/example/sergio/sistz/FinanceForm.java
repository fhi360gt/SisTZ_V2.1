...
public class FinanceForm extends Activity implements View.OnClickListener, TextWatcher{
    ...
    //Double col5=0.00, col6=0.00, col7=0.00, col8=0.00, col9=0.00, col10=0.00, col11=0.00, col12=0.00, col13=0.00, col14=0.00;
    int rg1_id ;
    int rg2_id;
    int rg3_id ;
    int rg4_id ;
...
//        col1= precision.format(Double.valueOf(_col1.getText().toString()));
//        col2= precision.format(Double.valueOf(_col2.getText().toString()));
...
//            _col1.setText(precision.format(Double.valueOf(cur_data.getString(1))));
//            _col2.setText(precision.format(Double.valueOf(cur_data.getInt(2))));
