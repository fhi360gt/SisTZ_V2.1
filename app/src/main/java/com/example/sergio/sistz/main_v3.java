...
public class main_v3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, OnChildClickListener, ExpandableListView.OnGroupClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //toolbar.setNavigationIcon(R.drawable.menu_icon_green);
...
//        toolsfncs.logFunctions(this, one,one,one);
    ...
    private void getAlerts() {
        ...
        alerts.add(new Alerts(R.drawable.alert,"School characteristics"));
        alerts.add(new Alerts(R.drawable.no_cellular,"No data "));
        alerts.add(new Alerts(R.drawable.no_signal,"No signal"));
        alerts.add(new Alerts(R.drawable.data_transfer_ready,"Behaviour"));
        alerts.add(new Alerts(R.drawable.data_transfer_ready,"teacher"));
        alerts.add(new Alerts(R.drawable.data_transfer_ready,"Student"));
    }

    private void showAlerts() {
       lv_alerts.setAdapter(new AlertsAdapter(this, R.layout.expandable_list_row_alert_layout,alerts));
    }
...
//                    }
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int i, int i1, long id) {
        ...
        if (i==2 && i1==0) {
            Intent intent = new Intent(main_v3.this, FinanceForm.class);
            startActivity(intent);
        }
        if (i==3 && i1==0) {
            Intent intent = new Intent(main_v3.this, ReportTeacherStaff.class);
            startActivity(intent);
        }
        if (i==3 && i1==1) {
            Intent intent = new Intent(main_v3.this, ReportS.class);
            startActivity(intent);
        }
        if (i==3 && i1==2) {
            Intent intent = new Intent(main_v3.this, ReportA.class);
            startActivity(intent);
        }
        return false;
    }
