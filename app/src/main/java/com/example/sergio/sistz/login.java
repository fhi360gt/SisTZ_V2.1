...
public class login extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _col3.setText("http://fhi360bi.org/user/tz_app/version.txt");
         //_col2.setFocusable(true);  // ******** desabilita edición
    ...
    public void loadRecord() {
        ...
        if (cur_data.getCount() > 0) {
            ...
            //_col3.setText("http://fhi360bi.org/user/tz_app/version.txt");
            //if (cur_data.getString(3).toString() != null ) {_col3.setText(cur_data.getString(3));}
            _IU = "U";
        } else {_IU = "I";}
        cur_data.close();
        dbSET.close();
    ...
    public void updateRecord () {
        ...
        //if (!_col1.getText().toString().isEmpty()){
            ...
            //reg.put("flag", _IU); sql = sql  + "login;" + getEMIS_code() + delimit;
