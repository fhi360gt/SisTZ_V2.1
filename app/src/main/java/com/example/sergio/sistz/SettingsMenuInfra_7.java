...
public class SettingsMenuInfra_7 extends Fragment implements View.OnClickListener {
    //public class SettingsMenuInfra_7 extends ActionBarActivity implements View.OnClickListener{
    ...
    public void loadRecord() {
        ...
        if (cur_data.getCount() > 0) {
            ...
            if(_col1 != null) {switch (_col1) {case "1":rb_yes1.setChecked(true);break;case "2":rb_no1.setChecked(true);break;default:break;}}
            _col2.setText(cur_data.getString(2));
            _col3 = cur_data.getString(3);
            if(_col3 != null) {switch (_col3) {case "1":rb_yes2.setChecked(true);break;case "2":rb_no2.setChecked(true);break;default:break;}}
            _col4.setText(cur_data.getString(4));
            _col5 = cur_data.getString(5);
            if(_col5 != null) {switch (_col5) {case "1":rb_yes3.setChecked(true);break;case "2":rb_no3.setChecked(true);break;default:break;}}
            _col6.setText(cur_data.getString(6));
            _col7 = cur_data.getString(7);
            if(_col7 != null) {switch (_col7) {case "1":rb_yes4.setChecked(true);break;case "2":rb_no4.setChecked(true);break;default:break;}}
            _col8.setText(cur_data.getString(8));
            _col9 = cur_data.getString(9);
            if(_col9 != null) {switch (_col9) {case "1":rb_yes5.setChecked(true);break;case "2":rb_no5.setChecked(true);break;default:break;}}
            _col10.setText(cur_data.getString(10));
            _col11 = cur_data.getString(11);
            if(_col11 != null) {switch (_col11) {case "1":rb_yes6.setChecked(true);break;case "2":rb_no6.setChecked(true);break;default:break;}}
            _col12.setText(cur_data.getString(12));
            _col13 = cur_data.getString(13);
            if(_col13 != null) {switch (_col13) {case "1":rb_yes7.setChecked(true);break;case "2":rb_no7.setChecked(true);break;default:break;}}
            _col14.setText(cur_data.getString(14));

            // **************** Frame 2  ******************
            //Toast.makeText(getContext(),"cb1="+ cur_data.getString(15) + ", cb2=" + cur_data.getString(16) + ", cb3=" + cur_data.getString(17),Toast.LENGTH_SHORT).show();
            ...
            if(cur_data.getInt(35)==2) {rb_no8.setChecked(true);}
            ...
            if(cur_data.getInt(38)==2) {rb_no9.setChecked(true);}
            ...
            if(cur_data.getInt(41)==2) {rb_no10.setChecked(true);}
            ...
            if(cur_data.getInt(44)==0) {rb_no11.setChecked(true);}
            ...
            if(cur_data.getInt(47)==2) {rb_no12.setChecked(true);}
    ...
    public void updateRecord () {
        ...
        //if (!_col2.getText().toString().isEmpty()){
            ...
            if (!_col2.getText().toString().isEmpty()){reg.put("r1a2", Integer.parseInt(_col2.getText().toString()));} sql = sql + _col2.getText().toString() + delimit;

            if (rb_yes2.isChecked() == true) {reg.put("r1b1", 1); sql = sql + "1" + delimit;}
            else if (rb_no2.isChecked() == true) {reg.put("r1b1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col4.getText().toString().isEmpty()){reg.put("r1b2", Integer.parseInt(_col4.getText().toString()));} sql = sql + _col4.getText().toString() + delimit;

            if (rb_yes3.isChecked() == true) {reg.put("r1c1", 1); sql = sql + "1" + delimit;}
            else if (rb_no3.isChecked() == true) {reg.put("r1c1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col6.getText().toString().isEmpty()){reg.put("r1c2", Integer.parseInt(_col6.getText().toString()));} sql = sql + _col6.getText().toString() + delimit;

            if (rb_yes4.isChecked() == true) {reg.put("r1d1", 1); sql = sql + "1" + delimit;}
            else if (rb_no4.isChecked() == true) {reg.put("r1d1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col8.getText().toString().isEmpty()){reg.put("r1d2", Integer.parseInt(_col8.getText().toString()));} sql = sql + _col8.getText().toString() + delimit;

            if (rb_yes5.isChecked() == true) {reg.put("r1e1", 1); sql = sql + "1" + delimit;}
            else if (rb_no5.isChecked() == true) {reg.put("r1e1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col10.getText().toString().isEmpty()){reg.put("r1e2", Integer.parseInt(_col10.getText().toString()));} sql = sql + _col10.getText().toString() + delimit;

            if (rb_yes6.isChecked() == true) {reg.put("r1f1", 1); sql = sql + "1" + delimit;}
            else if (rb_no6.isChecked() == true) {reg.put("r1f1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col12.getText().toString().isEmpty()){reg.put("r1f2", Integer.parseInt(_col12.getText().toString()));} sql = sql + _col12.getText().toString() + delimit;

            if (rb_yes7.isChecked() == true) {reg.put("r1g1", 1); sql = sql + "1" + delimit;}
            else if (rb_no7.isChecked() == true) {reg.put("r1g1", 2); sql = sql + "2" + delimit;}
            else {sql = sql + "" + delimit;}

            if (!_col14.getText().toString().isEmpty()){reg.put("r1g2", Integer.parseInt(_col14.getText().toString()));} sql = sql + _col14.getText().toString() + delimit;
            ...
            if (!other1.getText().toString().isEmpty()){reg.put("r3a3", other1.getText().toString());} sql = sql + other1.getText().toString() + delimit;
            ...
            if (!other2.getText().toString().isEmpty()){reg.put("r3b3", other2.getText().toString());} sql = sql + other2.getText().toString() + delimit;
            ...
            if (!other3.getText().toString().isEmpty()){reg.put("r3c3", other3.getText().toString());} sql = sql + other3.getText().toString() + delimit;
            ...
            if (!other4.getText().toString().isEmpty()){reg.put("r3d3", other4.getText().toString());} sql = sql + other4.getText().toString() + delimit;
            ...
            if (!other5.getText().toString().isEmpty()){reg.put("r3e3", other5.getText().toString());} sql = sql + other5.getText().toString() + delimit;
