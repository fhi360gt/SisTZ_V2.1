...
public class SettingsMenuInfra_6 extends Fragment implements View.OnClickListener{
    ...
    LinearLayout ll_q3; // ************ FrameLayout ***************
    ...
    RadioButton _col6a, _col6b, _col7a, _col7b, _col11a, _col11b, _col12a, _col12b, _col12c, _col13a, _col13b, _col13c, _col13d, _col13e, _col14a, _col14b, _col14c;
    String _IU="U";
    ...
    public void loadRecord() {
        ...
        Cursor cur_data = dbSET.rawQuery("SELECT _id, q1a, q1b, q1c, q1d, q1e, q2a, q2b, q2c, q2d, q2e, q3a, q3b, q3c, q3d, q3e1, q3e2, q3e3, q3e4, q3e5, q3e6, q3f1, q3f2, q3f3, q3f4, q3f5, q3f6, q3f7, q3f8, q3f9,  q3f10, q3f11, q3f12, q3f13, q3f14, q3f15, q3f16, q3f17, q3f18, q3f19, q3f20, q3f21, q3f22, q3g1, q3g2, q3g3, q3g4, flag FROM q WHERE _id=1",null);
        ...
        if (cur_data.getCount() > 0) {
            ...
            if(cur_data.getInt(11)==0) {_col11b.setChecked(true);}
    ...
    public void updateRecord () {
        ...
        //if (!_col1.getText().toString().isEmpty()){  // sirve para validar que un campo _ID
        // **************** Part 1 *****************************
            ...
            //reg.put("flag", _IU); sql = sql + _IU + ";q;" + SettingsMenuInfra_0.EMIS_code + delimit;
        ...
        // **************** Part 2 *****************************
            ...
            else if(_col11b.isChecked()==true) {reg.put("q3a",0); sql = sql + "0" + delimit;}
            else {sql = sql + "" + delimit;}
